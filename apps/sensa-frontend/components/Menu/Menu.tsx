            ...
            <GridColumn span={['12/12', '12/12', '6/12', '7/12', '8/12']}>
              ...
              >
                <div className={styles.mainContainer}>
                    ...
                    {renderLogo(
                      <>
                        <Box
                          ...
                          marginRight={[1, 4]}
                        >
                          <AlthingiLogo width={40} iconOnly title={logoTitle} />
                        </Box>
                        <Box
                          display={['none', 'none', 'none', 'block']}
                          marginRight={4}
                        >
                          <AlthingiLogo width={160} title={logoTitle} />
                        </Box>
                      </>,
                    )}
                    <Box
                  ...
                  >
                    <Text variant="eyebrow">Vinna Alþingis</Text>
                    <Box className={styles.content}>
                      <Box className={styles.menuBox}>
                        ...
                        <Box className={styles.listBox}>
                          ...
                          <Text>Kjördæmi</Text>
                          <Text>Nefndir</Text>
                          <Text>Forseti og Forsætisnefnd Alþingis</Text>
                          <Text>Skjalasafn</Text>
                        </Box>
                      </Box>
                      <Box className={styles.menuBox}>
                        <Text variant="h3" as="h3">
